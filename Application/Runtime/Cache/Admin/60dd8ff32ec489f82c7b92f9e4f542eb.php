						...
						<div class="page-header">
							<h1>
								...
								<div class="row">
                                    ...
                                    <div class="col-sm-5">
										<form class="form-inline" action="/webgame/index.php/admin/system/manager_serch" method="post">

                                           	<a class="btn btn-sm btn-warning" href="/webgame/index.php/admin/System/rule_add"><i class="icon-hdd bigger-111"></i>添加权限规则</a>
                                            <a class="btn btn-sm btn-success" href="/webgame/index.php/admin/system/menu_list"><i class="icon-gift bigger-111"></i>菜单管理</a>
										</form>
                                   </div>
                                	...
                                	<div class="col-sm-12">
											<div class="tab-content">
												...
												<thead class="thin-border-bottom">
													<tr>
														<th class="center">操作ID</th>
														<th class="center">操作名称</th>
														<th class="center">操作URL</th>
												...
												<tbody>
                                                	<?php if(is_array($rules)): $k = 0; $__LIST__ = $rules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($k % 2 );++$k;?><tr>
														<td class="center">
                                                        <?php echo ($data["id"]); ?>
														</td>
														<td class="center">
														...
														<td class="center">
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/webgame/index.php/admin/system/rule_edit/id/<?php echo ($data["id"]); ?>">
																	<i class="icon-pencil bigger-130" title="编辑规则"></i>
																</a>

																<a class="red" href="/webgame/index.php/admin/system/rule_del/id/<?php echo ($data["id"]); ?>">
																	<i class="icon-trash bigger-130" title="删除规则"></i>
																</a>
															</div>
