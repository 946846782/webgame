						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
                                    ...
                                    <div class="col-sm-5">
										<form class="form-inline" action="/webgame/index.php/admin/member/manager_serch" method="post">
										
											<span class="input-icon">
												<select class="form-control" name="roleid">
                                            	<?php if(is_array($role)): foreach($role as $role_id=>$role_name): if(isset($GET_roleid)){ ?>
                                                    			<?php  if($GET_roleid == $role_id){ ?>
                                           ...
                                           <button type="submit" class="btn btn-sm btn-primary" data-toggle="button">查询</button>
                                           	<a class="btn btn-sm btn-warning" href="/webgame/index.php/System/manager_add/"><i class="icon-hdd bigger-111"></i>添加管理员</a>
                                            <a class="btn btn-sm btn-success" href="/webgame/index.php/System/role_list/"><i class="icon-gift bigger-111"></i>角色管理</a>
										</form>
                                   </div>
											...
											<div class="tab-content">
												...
												<thead class="thin-border-bottom">
													<tr>
                                                        ...
                                                        <th class="center">转态</th>
														<th class="center">在线</th>
                                                        <th class="center">操作</th>
													</tr>
												</thead>

												<tbody>
                                                	<?php if(is_array($member)): $k = 0; $__LIST__ = $member;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($k % 2 );++$k;?><tr>
														<td class="center">
                                                        <?php echo ($data["uid"]); ?>
														</td>
														<td class="center">
                                                        ...
                                                        <td class="center">
														<?php echo $role[$data['mg_role_id']]; ?>
														</td>
                                                        <td class="center">
														<?php echo ($data["static"]); ?>
														</td>
                                                        <td class="center">
                                                        &nbsp;
														</td>
														...
														<td class="center">
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/webgame/index.php/admin/Member/member_show/id/<?php echo ($data["uid"]); ?>">
																	<i class="icon-zoom-in bigger-130" title="查看管理员"></i>
																</a>

																<a class="green" href="/webgame/index.php/admin/Member/member_rule/id/<?php echo ($data["uid"]); ?>">
																	<i class="icon-comment bigger-130" title="角色"></i>
																</a>

																<a class="green" href="/webgame/index.php/admin/Member/member_edit/id/<?php echo ($data["uid"]); ?>">
																	<i class="icon-pencil bigger-130" title="编辑管理员"></i>
																</a>

																<a class="red" href="/webgame/index.php/admin/Member/member_del/id/<?php echo ($data["uid"]); ?>">
																	<i class="icon-trash bigger-130" title="删除管理员"></i>
																</a>
															</div>
