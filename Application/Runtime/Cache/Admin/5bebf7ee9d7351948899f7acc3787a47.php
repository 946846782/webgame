						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">纽扣</span>
									<span class="white">游戏系统</span>
								</h1>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="/webgame/index.php/admin/Base/login" method="post">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Username" id="username" name="account"/>
															<i class="icon-user"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
   													...
   													<label class=" clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Code number" id="code" name="code"/>
															<i class="icon-credit-card"></i>
														</span>
													</label>
                                                    <label class=" clearfix">
												<img src="/webgame/index.php/admin/Comhelper/verify" onclick="this.src='/webgame/index.php/admin/Comhelper/verify?'+Math.random()"  />
													</label>
								...
								<div id="signup-box" class="signup-box widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="/webgame/index.php/admin/Base/register" method="post">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
