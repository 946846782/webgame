                        ...
                        <div class="row">
                           ...
                           <div class="table-responsive">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="/webgame/index.php/admin/System/menu_add" enctype="multipart/form-data" method="post">
                                	<br/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                            <select class="col-xs-10 col-sm-5" name="pid">
												...
												<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>"><?php echo ($val["line"]); echo ($val["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" placeholder="" name="name" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="ac_path" placeholder="" name="url" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="ico" placeholder="" name="ico" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
