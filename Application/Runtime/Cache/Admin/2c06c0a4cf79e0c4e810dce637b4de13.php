					...
					<div class="page-content">
                        ...
                        <div class="row">
							...
							<div class="col-xs-12">
								...
								<div class="row">
                                    	<p>
											<a class="btn" href="/webgame/index.php/admin/system/rule_list"><i class="icon-undo bigger-110"></i>返回</a>
											<a class="btn btn-success" href="/webgame/index.php/admin/system/menu_list"><i class="icon-gift bigger-111"></i>菜单管理</a>
										</p>
                                </div>
                           ...
                           <div class="table-responsive">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="/webgame/index.php/admin/System/rule_edit" enctype="multipart/form-data" method="post">
									<input type="hidden" name="rule_id" value="<?php if($rule_result[0]['id']){ echo $rule_result[0]['id'];} ?>">
                                	<br/>
                              		<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">顶级菜单</label>

										<div class="col-sm-9">
                                            <select class="col-xs-10 col-sm-5" name="pid">
												<option value="0">顶级菜单</option>
												<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>" <?php if($val['id'] == $rule_result[0]['pid']){ echo "selected='selected'";} ?>><?php echo ($val["line"]); echo ($val["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>

											</select>
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">顶级菜单</span>
									    	</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="title" placeholder="" name="title" class="col-xs-10 col-sm-5" value="<?php if($rule_result[0]['title']){ echo $rule_result[0]['title']; } ?>" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">规则名称</span>
									    	</span>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">规则Url </label>

										<div class="col-sm-9">
											<input type="text" id="name" placeholder="" name="name" class="col-xs-10 col-sm-5" value="<?php if($rule_result[0]['name']){ echo $rule_result[0]['name'];} ?>"/>
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">规则Url</span>
									    	</span>
										</div>
									</div>
