								...
								<div class="row">
                                    ...
                                    <div class="col-sm-5">
										<form class="form-inline" action="/webgame/index.php/admin/system/manager_serch" method="post">
                                            ...
                                            <a class="btn btn-sm btn-success" href="/webgame/index.php/admin/system/menu_add"><i class="icon-gift bigger-111"></i>添加菜单</a>
										</form>
                                   </div>
                                ...
                                <div class="row">
                                	<div class="col-sm-12">
											<div class="tab-content">
												...
												<tbody>
                                                	<?php if(is_array($menus)): $k = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($k % 2 );++$k;?><tr>
														<td class="center">
                                                        <?php echo ($data["id"]); ?>
														</td>
														<td class="center">
														<i class="<?php echo ($data["ico"]); ?>"></i>	
                                                        <?php echo ($data["name"]); ?>
														</td>
                                                        <td class="center">
                                                        <?php echo ($data["url"]); ?>
														...
														<td class="center">
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/webgame/index.php/admin/system/menu_edit/id/<?php echo ($data["id"]); ?>">
																	<i class="icon-pencil bigger-130" title="编辑规则"></i>
																</a>

																<a class="red" href="/webgame/index.php/admin/system/menu_del/id/<?php echo ($data["id"]); ?>">
