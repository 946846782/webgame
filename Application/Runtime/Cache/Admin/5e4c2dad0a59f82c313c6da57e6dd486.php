                                	...
                                	<div class="col-sm-12">
											<div class="tab-content">
												...
												<thead class="thin-border-bottom">
													<tr>
														<th class="center">开服时间</th>
														<th class="center">游戏</th>
														<th class="center">区服</th>
														<th class="center">区服ID</th>
                                                        <th class="center">区服名</th>
														<th class="center">服务器状态</th>
                                                        <th class="center">维护跳转地址</th>
														<th class="center">设置时间</th>
														<th class="center">CPS服务器设置</th>
                                                        <th class="center">操作</th>
													</tr>
												</thead>

												<tbody>
                                                	<?php if(is_array($serverlist)): $i = 0; $__LIST__ = $serverlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Server): $mod = ($i % 2 );++$i;?><tr>
														<td class="center">
                                                        <?php echo ($Server["opentime"]); ?>
														</td>
														<td class="center">
                                                        <?php echo ($Server["shortname"]); ?>
														</td>
                                                        <td class="center">
                                                        <?php echo ($Server["seq"]); ?>
														</td>
                                                        <td class="center">
                                                        <?php echo ($Server["serverid"]); ?>
														</td>
                                                        <td class="center">
                                                        <?php echo ($Server["serverdesc"]); ?>
														</td>
                                                        <td class="center">
                                                        <?php echo ($Server["status"]); ?>
														</td>
                                                        <td class="center">
                                                        <?php echo ($Server["go_url"]); ?>
														</td>

														<td class="center">
															<?php echo ($Server["ctime"]); ?>
														</td>
                                                        <td class="center">
                                                        <?php echo ($Server["orderid"]); ?>
														</td>

														<td class="center">
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/webgame/index.php/admin/server/server_show/id/<?php echo ($Server["serverid"]); ?>">
																	<i class="icon-zoom-in bigger-130" title="查看"></i>
																</a>

																<a class="green" href="/webgame/index.php/admin/server/server_edit/id/<?php echo ($Server["serverid"]); ?>">
																	<i class="icon-pencil bigger-130" title="编辑"></i>
																</a>

																<a class="red" href="/webgame/index.php/admin/server/server_del/id/<?php echo ($Server["serverid"]); ?>">
