					...
					<div class="page-content">
                        ...
                        <div class="row">
							...
							<div class="col-xs-12">
								...
								<div class="row">
                                    	<p>
											<a class="btn" href="/webgame/index.php/Card/card_list/"><i class="icon-undo bigger-110"></i>返回</a>
											<a class="btn btn-success" href="/webgame/index.php/Card/card_add"><i class="icon-gift bigger-111"></i>角色管理</a>
										</p>
                                </div>
                           ...
                           <div class="table-responsive">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="/webgame/index.php/admin/Member/member_add" enctype="multipart/form-data" method="post">
                                	<br/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="account" placeholder="" name="account" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">登录账号</span>
									    	</span>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">用户呢称 </label>

										<div class="col-sm-9">
											<input type="text" id="name" placeholder="" name="name" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">你的花名</span>
									    	</span>
										</div>
									</div>
