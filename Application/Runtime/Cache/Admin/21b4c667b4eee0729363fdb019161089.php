					...
					<div class="page-content">
                        ...
                        <div class="row">
							...
							<div class="col-xs-12">
								...
								<div class="row">
                                    	<p>
											<a class="btn" href="/webgame/index.php/admin/system/menu_list"><i class="icon-undo bigger-110"></i>返回</a>
                           ...
                           <div class="table-responsive">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="/webgame/index.php/admin/System/menu_edit" enctype="multipart/form-data" method="post">
                                	<br/>
                                	<input type="hidden" name="menu_id" value="<?php echo ($menu_result[0]['id']); ?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                            <select class="col-xs-10 col-sm-5" name="pid">
												...
												<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>" <?php if($val['id'] == $menu_result[0]['pid']){ echo "selected='selected'";} ?>><?php echo ($val["line"]); echo ($val["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" placeholder="" name="name" class="col-xs-10 col-sm-5" value="<?php echo ($menu_result[0]['name']); ?>" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">菜单名称</span>
									    	</span>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="ac_path" placeholder="" name="url" class="col-xs-10 col-sm-5" value="<?php echo ($menu_result[0]['url']); ?>" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">菜单Url</span>
									    	</span>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="ico" placeholder="" name="ico" class="col-xs-10 col-sm-5" value="<?php echo ($menu_result[0]['ico']); ?>" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">菜单图标</span>
									    	</span>
										</div>
									</div>
