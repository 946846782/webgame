...
<form action="/webgame/index.php/admin/Member/member_rule" method="post" enctype="multipart/form-data">
        ...
        <!-- checked="checked"  -->
        <?php if(empty($group)): ?><h1>rule没有数据</h1><?php endif; ?>
		<?php if(is_array($group)): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list-group-item">
		<input type="checkbox" name="group_ids[]" value="<?php echo ($vo["id"]); ?>" <?php if(in_array($vo['id'],$checked)){ echo 'checked="checked"'; } ?> >
