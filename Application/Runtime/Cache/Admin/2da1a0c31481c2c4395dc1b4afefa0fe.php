						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
                                    ...
                                    <div class="col-sm-5">
										<form class="form-inline" action="/webgame/index.php/System/index" method="post">
                                           	<a class="btn btn-sm btn-warning" href="/webgame/index.php/admin/Member/member_add/"><i class="icon-hdd bigger-111"></i>添加管理员</a>
                                                	...
                                                	<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($k % 2 );++$k;?><tr>
														...
														<td class="center">
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="green" href="/webgame/index.php/admin/System/group_rule_add/id/<?php echo ($k); ?>">
																	<i class="icon-lock bigger-130" title="操作权限"></i>
																</a>

																<a class="green" href="/webgame/index.php/admin/System/group_menu_add/id/<?php echo ($k); ?>">
																	<i class="icon-lock bigger-130" title="菜单权限"></i>
																</a>
                                                                
																<a class="green" href="/webgame/index.php/admin/System/group_edit/id/<?php echo ($k); ?>">
																	<i class="icon-pencil bigger-130" title="编辑用户组"></i>
																</a>

																<a class="red" href="/webgame/index.php/admin/System/group_del/id/<?php echo ($k); ?>">
																	<i class="icon-trash bigger-130" title="删除用户组"></i>
																</a>
															</div>
