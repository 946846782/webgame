							...
							<h1>
                                ...
                                <div class="row">
									<form class="form-inline">
										<div class="col-sm-9">
											<span class="input-icon">
												<input type="text" class="form-control" placeholder="游戏名">
												<i class="icon-search blue"></i>
											</span>

											<span class="input-icon">
												<input type="text" class="form-control" placeholder="游戏ID">
												<i class="icon-search blue"></i>
											</span>
                                	...
                                	<div class="col-sm-12">
											<div class="tab-content">
												...
												<thead class="thin-border-bottom">
													<tr>
														<th class="center">游戏ID</th>
														<th class="center">游戏名称</th>
														<th class="center">游戏类型</th>
														<th class="center">官网地址</th>
														<th class="center">推广地址</th>
                                                        <th class="center">充值比例</th>
														<th class="center">兑换单位</th>
												...
												<tbody>
                                                	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Game): $mod = ($i % 2 );++$i;?><tr>
														<td class="center">
                                                        <?php echo ($Game["gameid"]); ?>
														</td>
														<td class="center">
                                                        <?php echo ($Game["shortname"]); ?>
														</td>
                                                        <td class="center">
                                                        <?php echo ($Game["gametype"]); ?>
														</td>
                                                        <td class="center">
                                                        <?php echo ($Game["weburl"]); ?>
														</td>
                                                        <td class="center">
                                                        
														</td>
                                                        <td class="center">
                                                        <?php echo ($Game["changerater"]); ?>
														</td>
                                                        <td class="center">
                                                        <?php echo ($Game["coin"]); ?>
														</td>
														...
														<td class="center">
                                                        	<?php if($Game["status"] == 1): ?><span class="label label-sm label-success">正常营运</span>
                                                            <?php elseif($Game["status"] == 2): ?><span class="label label-sm label-warning">停止运营</span>
                                                            <?php else: ?> <span class="label label-sm label-info">接入中...</span><?php endif; ?>
															
														</td>
                                                        <td class="center">
                                                        <?php echo ($Game["orderid"]); ?>
														</td>

														<td class="center">
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
					<a class="blue" href="/webgame/index.php/admin/game/game_show/id/<?php echo ($Game["id"]); ?>/gameid/<?php echo ($Game["gameid"]); ?>">
							<i class="icon-zoom-in bigger-130" title="查看"></i>
					</a>
                                                                
                    <a class="red" href="/webgame/index.php/admin/Server/server_cup/id/<?php echo ($Game["id"]); ?>/gameid/<?php echo ($Game["gameid"]); ?>">
							<i class="icon-exchange bigger-130" title="游戏合区"></i>
					</a>

					<a class="green" href="/webgame/index.php/admin/game/game_edit/id/<?php echo ($Game["id"]); ?>/gameid/<?php echo ($Game["gameid"]); ?>">
							<i class="icon-pencil bigger-130" title="编辑"></i>
					</a>

					<a class="red" href="/webgame/index.php/admin/game/game_del/id/<?php echo ($Game["id"]); ?>/gameid/<?php echo ($Game["gameid"]); ?>">
			...
			*/
				...
				$( "#id-btn-dialog1" ).on('click', function(e) {
					...
					var dialog = $( "#dialog-message" ).removeClass('hide').dialog({
						modal: true,
						title: "<div class='widget-header widget-header-big'><h4 class='smaller'><i class='icon-ok'></i> 新增游戏</h4></div>",
						title_html: true,
						width : '500',
