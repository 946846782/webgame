                        ...
                        <div class="row">
							...
							<div class="col-xs-12">
								...
								<div class="row">
                                    	<p>
											...
											<a class="btn btn-success" href="/webgame/index.php/admin/System"><i class="icon-gift bigger-111"></i>添加管理员</a>
										</p>
                                </div>
                           ...
                           <div class="table-responsive">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="/webgame/index.php/admin/System/group_add" enctype="multipart/form-data" method="post">
                                	<br/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="role_name" placeholder="" name="title" class="col-xs-10 col-sm-5" />
